...
def seed_users():
    demo = User(
        first_name='Demo', last_name='User', username='Demo', image_url='https://images.pexels.com/photos/771742/pexels-photo-771742.jpeg', email='demo@aa.io', password='password')
    marnie = User(
        first_name='Marnie', last_name='Rodriguez', username='marnie', image_url='https://i.etsystatic.com/36532523/r/il/97ae46/4078306713/il_340x270.4078306713_n74s.jpg', email='marnie@aa.io', password='password')
    bobbie = User(
        first_name='Bobbie', last_name='Smiths', image_url='https://static-cse.canva.com/blob/951359/1600w-YTfEMXMuMCs.jpg', username='bobbie', email='bobbie@aa.io', password='password')
    Bella = User(
        first_name='Bella', last_name='Poarch', image_url='https://editors.dexerto.com/wp-content/uploads/2021/01/BellaPoarchTop5.jpg', username='bellapoarch', email='bella@aa.io', password='password')
    Will = User(
